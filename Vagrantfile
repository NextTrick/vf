...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
    ...
    #config.vm.synced_folder "./", "/var/www/sm", type: "rsync", id: "vagrant", :nfs => false,
    #    :mount_options => ["dmode=777", "fmode=666"]

    config.vm.synced_folder "./", "/opt/ts/vf.com.pe", type: "nfs"
    ...
    #config.vm.provision :shell, path: "ansible/script.sh", args: ["default"]

    config.vm.provision :shell, inline: "echo Good job, now enjoy your new vbox: http://10.0.0.15"

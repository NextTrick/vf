        ...
        <div id="page" class="clearfix">
            <div id="site-header-wrap">
                ...
                <?php if(construct_get_option( 'top_header' )) { ?>
                    ...
                    <!-- /#top-bar -->
                <?php } ?>
                <header id="site-header" class="header-front-page <?php if(construct_get_option('header_layout')=='2'){echo 'style-5';}else{echo 'style-1';} ?>">
                    <div id="site-header-inner" class="container">
                        <div class="wrap-inner">
                            <div id="site-logo" class="clearfix">
                                <div id="site-logo-inner">
                                    <a href="<?php echo esc_url( home_url('/') ); ?>" class="main-logo">                                    
                                        <img src="<?php echo esc_url(construct_get_option( 'logo' )); ?>" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
